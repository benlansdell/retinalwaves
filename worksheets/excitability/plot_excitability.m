...
%saveplot(gcf, ['./worksheets/excitability/excitability_plots/compare_sim_auto_delta.eps']);
plot2svg(['./worksheets/excitability/excitability_plots/compare_sim_auto_delta_' ic '.eps'], gcf);
