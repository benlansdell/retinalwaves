function plotmult_vert(h, filename, nframes, format, dimensions, journal)
%plotmult_vert       Saves the specified plot consisting of nframes of size specified in dimensions
%
% Usage:
...
%                       plotmult(gcf, './plots/test.eps', 2, 'eps', 1, 'plos1');
	...
	dimensions(2) = dimensions(2)*nframes;
	box = [0 0 dimensions];
